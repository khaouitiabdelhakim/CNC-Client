...
@Component({
  selector: 'app-add-system-manager',
  templateUrl: './add-system-manager.component.html',
  styleUrls: ['./add-system-manager.component.scss']
})
export class AddSystemManagerComponent {
  ...
  constructor(
    ...
    this.user = new User();
    this.user.role = 'SYSTEM_MANAGER'; // Set the role here
  }
