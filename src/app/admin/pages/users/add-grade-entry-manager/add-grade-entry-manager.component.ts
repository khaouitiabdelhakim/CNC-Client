...
@Component({
  selector: 'app-add-grade-entry-manager',
  templateUrl: './add-grade-entry-manager.component.html',
  styleUrls: ['./add-grade-entry-manager.component.scss']
})
export class AddGradeEntryManagerComponent {
  ...
  constructor(
    ...
    this.user = new User();
    this.user.role = 'GRADE_ENTRY_AGENT'; // Set the role here
  }
