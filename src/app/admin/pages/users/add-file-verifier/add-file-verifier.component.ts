...
@Component({
  selector: 'app-add-file-verifier',
  templateUrl: './add-file-verifier.component.html',
  styleUrls: ['./add-file-verifier.component.scss']
})
export class AddFileVerifierComponent {
  ...
  constructor(
    ...
    this.user = new User();
    this.user.role = 'FILE_VERIFIER'; // Set the role here
  }
